...
**Tech Stack:** Phaser game runtime, Playwright, MediaRecorder, FFmpeg, Qwen3-TTS, HyperFrames 0.7.49, Git/GitHub.
...
- [x] **Step 1: Add deterministic state setup for the three captures**
...
- [x] **Step 2: Record skill and Laojun proof clips**
...
- [x] **Step 3: Record a real two-session battle**
...
Expected: `coop-battle.mp4` visibly contains two independently authenticated Wukong instances with distinct username nameplates in the same level after both sessions joined the same room.

- [x] **Step 4: Inspect clip metadata and representative frames**
...
- [x] **Step 1: Rewrite narration around the proof shots**
...
- [x] **Step 2: Generate a mainland Mandarin neural voice master**

Run the local Qwen3-TTS CustomVoice model with its standard Mandarin Serena voice, then normalize to 48 kHz stereo PCM WAV using FFmpeg. Expected: neutral standard Mandarin with no Taiwanese or Cantonese prosody.

- [x] **Step 3: Generate timing data and audio checks**
...
- [x] **Step 1: Replace claim-only scenes with proof footage**
...
- [x] **Step 4: Render and visually inspect**
